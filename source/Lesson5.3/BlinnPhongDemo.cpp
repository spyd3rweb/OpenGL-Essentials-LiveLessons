...
namespace Rendering
{
	...
	const Vector2f BlinnPhongDemo::LightRotationRate = Vector2f(2.0f * M_PI, 2.0f * M_PI);
	...
	BlinnPhongDemo::BlinnPhongDemo(Game& game, Camera& camera) :
		...
		mSpecularColor(ColorHelper::White), mSpecularPower(25.0f), mWorldMatrix(Eigen::Matrix4f::Identity())
	{
	}
