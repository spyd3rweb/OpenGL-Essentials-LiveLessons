...
namespace Rendering
{
	...
	void ColoredTriangleDemo::Initialize()
	{
		...
		VertexPositionColor vertices[] =
		{
			...
			*/
			VertexPositionColor(Vector4f(0.75f, -0.25f, 0.0f, 1.0f), ColorHelper::Red),
			VertexPositionColor(Vector4f(0.0f, 0.5f, 0.0f, 1.0f), ColorHelper::Green),
			VertexPositionColor(Vector4f(-0.75f, -0.25f, 0.0f, 1.0f), ColorHelper::Blue)
		};
