...
namespace Rendering
{
	...
	const Vector2f TransparencyMappingDemo::LightRotationRate = Vector2f(2.0f * M_PI, 2.0f * M_PI);
	...
	TransparencyMappingDemo::TransparencyMappingDemo(Game& game, Camera& camera) :
		...
		mAlphaMap(0), mTrilinearSampler(0), mWorldMatrix(Eigen::Matrix4f::Identity())
	{
	}
