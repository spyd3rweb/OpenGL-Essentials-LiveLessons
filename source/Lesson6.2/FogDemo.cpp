...
namespace Rendering
{
	...
	const Vector2f FogDemo::LightRotationRate = Vector2f(2.0f * M_PI, 2.0f * M_PI);
	...
	FogDemo::FogDemo(Game& game, Camera& camera) :
		...
		mFogColor(ColorHelper::CornflowerBlue), mFogStart(20.0f), mFogRange(40.0f), mWorldMatrix(Eigen::Matrix4f::Identity())
	{
	}
